var Delorean = Class.create({
	...
	extendOptions: function(destination,source){
 	...
 	plotMarkers: function(){
 		...
 		finish = this.drawLabel(this.paper.width-this.options.padding.right,y1,this.dates.last(),(this.dates.length%2==0));
 	...
 	drawLabel: function(x,y,date,alt){
 		...
 		label =  this.paper.text(x,y,labelTxt).attr({"text-anchor":"middle",'font-size':this.options.text.size,'font-weight':this.options.text.weight,'font':this.options.text.font});
